...
arch = [
    ...
    # conv1
    to_ConvConvRelu(name='cr1', s_filer=256, n_filer=(64, 64), offset="(0,0,0)",
    ...
    # conv2
    to_ConvConvRelu(name='cr2', s_filer=128, n_filer=(128, 128), offset="(3.4,0,0)",
    ...
    # conv3
    to_ConvConvRelu(name='cr3', s_filer=64, n_filer=("256", "256", "256"), offset="(3,0,0)",
    ...
    # conv4
    to_ConvConvRelu(name='cr4', s_filer=32, n_filer=("512", "512", "512"), offset="(2.6,0,0)",
    ...
    # conv5
    to_ConvConvRelu(name='cr5', s_filer=16, n_filer=("512", "512", "512"), offset="(2,0,0)",
    ...
    # flatten
    to_FullyConnected(name="fl", s_filer=4096, offset="(1.5,0,0)",
                      to="(p5-east)", width=1, height=1, depth=20, caption="fl"),

    # fc1
    to_FullyConnected(name="fc1", s_filer=8192, offset="(1.25,0,0)",
                      to="(fl-east)", width=1, height=1, depth=40, caption="fc1\ndr"),

    # fc2
    to_FullyConnected(name="fc2", s_filer=8192, offset="(1.25,0,0)",
                      to="(fc1-east)", width=1, height=1, depth=40, caption="fc2\ndr"),

    # fc3
    to_FullyConnected(name="fc3", s_filer=8192, offset="(1.25,0,0)",
                      to="(fc2-east)", width=1, height=1, depth=40, caption="fc3\ndr"),


    # sigmoid
    to_SoftMax(name="sg", n_filer=256, offset="(1.25,0,0)", to="(fc3-east)",
               width=1, height=1, depth=10, caption="SIGMOID", opacity=1.0),
